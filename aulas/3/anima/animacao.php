<style>
#fundo {
	background:url(anima/fundo.gif); 
	width:960px; 
	height:513px; 
	position:relative;
}
...
#resolucao {
	background:url(anima/resolucao.gif); 
	width:960px; 
	height:513px; 
	position:absolute;
	display:none;
...
#btn_fechar{
	background:url(anima/btn_fechar.png); 
...
#coco{
	height:30px;
	width:30px;
	background:url(anima/coco.png) 0 0 no-repeat;
	position:absolute;
	top:48px;
	left:465px;
}
...
#btn_start{
    ...
    height: 54px;
    width: 34px;
	background:url(anima/btn_start.png) 0 0 no-repeat;
